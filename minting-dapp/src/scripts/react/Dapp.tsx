...
const ContractAbi = require('../../../artifacts/contracts/' + CollectionConfig.contractName + '.sol/' + CollectionConfig.contractName + '.json').abi;
        ...
        :
          <div className="no-wallet">
            ...
            <div className="preview m-5">
              <img className="rounded-3xl" src="/build/images/preview.gif" alt="Collection preview" />
            </div>

            {!this.isWalletConnected() || this.state.isWhitelistMintEnabled ?
              <div className="merkle-proof-manual-address">
                <h2>Imperial Legion NFT</h2>
